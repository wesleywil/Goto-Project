...
import { HomePageAnimeButton, HomePageAnimeContainer, HomepageContainer, HomepageList, HomepageStatusButton, HomepageStatusContainer } from "./homepage.styles";
...
const Homepage = ()=>{
    ...
    return(
        <HomepageContainer>
            ...
            <AnimeSearch hidden={hiddenPanel}></AnimeSearch>
        </HomepageContainer>
    )
}
